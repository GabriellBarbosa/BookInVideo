...
<html lang="pt-br">
    <head>
        ...
        <script type="module" crossorigin src="<?= get_stylesheet_directory_uri(); ?>/react-app/index.js"></script>
        <link rel="stylesheet" href="<?= get_stylesheet_directory_uri(); ?>/react-app/index.css">
    </head>
    <body>
        <div id="root"></div>
    </body>
