...
function bookinvideo_register_css() {
    wp_register_style('bookinvideo-style', get_template_directory_uri() . '/style.css', [], '5.9');
...
function bookinvideo_register_hamburguer_menu_js() {
    wp_enqueue_script('menu-mobile-js', get_template_directory_uri() . '/assets/js/index.js', [], '1.6');
}
