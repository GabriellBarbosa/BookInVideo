...
function getPageTitle() {
    $currentPageTitle = single_post_title();
    if ($currentPageTitle) {
        return $currentPageTitle;
    } else {
        return 'BookInVideo - Curso de Código Limpo';
    }
...
<head>
    ...
    <meta name="description" content="Aprenda a desenvolver um código limpo, que revele propósito e evite perder horas tentando entender um código confuso.">
